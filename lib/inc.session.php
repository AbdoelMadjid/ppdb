<?php
if(empty($_SESSION['nisn'])) { //jika session berupa username kosong, makan baris dibawah akan muncul
	...
	echo "<meta http-equiv='refresh' content='0;url=index.php'>"; //jika session berjalan maka akan terlembar ke alamat link berikut
	exit;
