      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="media.php?page=dashboard" class="site_title"><i class="fa fa-paw"></i> <span>SMK Ma'arif 2 Gombong</span></a>
            </div>

            <div class="clearfix"></div>
            <?php
            $query = mysqli_query($connect, "SELECT * FROM admin, pengguna WHERE admin.idu = pengguna.nisn AND pengguna.nisn = '$_SESSION[nisn]' AND pengguna.hak_akses != 'Siswa'");
        ...
        <footer>
          <div class="pull-right">
            &copy; SMK Ma'arif 2 Gombong || design by <a href="https://colorlib.com">Colorlib</a> and <a href="https://vieyama.com">Vieyama</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
