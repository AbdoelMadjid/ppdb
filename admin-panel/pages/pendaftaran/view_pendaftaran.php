...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3>Pendaftaran <small>Siswa Baru SMK Ma'arif 2 Gombong</small></h3>
    </div>
  </div>
                      ...
                      Batas Awal Waktu Pendaftaran
                        <div class="form-group">
                            <div class='input-group date' id='myDatepicker0'>
                                <input type='text' name="awal" placeholder="Waktu Awal Pendaftaran" class="form-control" required/>
                    ...
                    <div class='col-sm-3'>
                        ...
                        <div class="form-group">
                            <div class='input-group date' id='myDatepicker1'>
                                <input type='text' name="akhir" placeholder="Waktu Akhir Pendaftaran" class="form-control" required/>
                                <span class="input-group-addon">
                                   <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
